...
<div class = "container mt-2 bg-transparent text-dark mb-3 text-center">
    <div class = "img-con ">
        <img src = "../../img/stories/grade1/Grade 1 Short Stories_page-0009.png" width ="60%" height="80%"/>

    </div>
    <nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="trees.php" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    ...
    <li class="page-item active"><a class="page-link" href="#.php">9</a></li>
    <li class="page-item"><a class="page-link" href="fish.php">10</a></li>

    <li class="page-item">
      <a class="page-link" href="fish.php">Next</a>
    </li>
  </ul>
</nav>
</div>
