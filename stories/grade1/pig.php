...
<div class = "container mt-2 bg-transparent text-dark mb-3 text-center">
    <div class = "img-con ">
        <img src = "../../img/stories/grade1/Grade 1 Short Stories_page-0003.png" width ="60%" height="80%"/>

    </div>
    <nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="len.php" tabindex="-1" aria-disabled="true">Previous</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="lizard.php">Next</a>
    </li>
  </ul>
</nav>
</div>
