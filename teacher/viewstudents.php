        ...
        <div class = "row">
            ...
            <div class="col-md-3 mb-3">
                <div class="card text-white bg-danger h-100">
                    <div class="card-header">Total Students in Grade 1</div>
                    <div class="card-body  text-center">
                        <h5 class="card-title"><i class="fa-solid fa-children fa-3x rounded-full  p-2" aria-hidden = "true"> </i> </h5>
                        <p class="card-text text-light"><?= gettotalg1(); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card text-white bg-success  h-100" > <!-- h-100 and adding mb3 will set the card 100 width-->
                <div class="card-header">Total Students in Grade 2</div>
                    <div class="card-body  text-center">
                        <h5 class="card-title"><i class="fa-solid fa-children  fa-3x rounded-full  p-2" aria-hidden = "true"> </i> </h5>
                        <p class="card-text text-light"><?= gettotalg2(); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card text-white bg-primary h-100">
                <div class="card-header">Total Students in Grade 3</div>
                    <div class="card-body  text-center">
                        <h5 class="card-title"><i class="fa-solid fa-children  fa-3x rounded-full  p-2" aria-hidden = "true"> </i> </h5>
                        <p class="card-text text-light"><?= gettotalg3(); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- update modal -->
<div class="modal fade" id="updateStudents" tabindex="-1" aria-labelledby="updateStudents" aria-hidden="true">
<form class="form-horizontal"  method="post" enctype="multipart/form-data" action = "../modal_structure/update_students.php">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">
        <div class="modal-header bg-success text-white">
            <h5 class="modal-title" id="updateStudents"> Update Students</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
...
<!-- delete modal -->
<div class="modal fade" id="deleteStudents" tabindex="-1" aria-labelledby="deleteStudents" aria-hidden="true">
<form class="form-horizontal"  method="post" enctype="multipart/form-data" action = "../modal_structure/delete_students.php">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">
        <div class="modal-header bg-danger text-light">
            <h5 class="modal-title" id="deleteStudents"> Delete Students</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
...
<div class="modal fade" id="viewStudents" tabindex="-1" aria-labelledby="viewStudents" aria-hidden="true">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
        <div class="modal-header bg-primary text-white">
            <h5 class="modal-title" id="viewStudents"> Student Information</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
...
<!-- Report modal -->
<div class="modal fade" id="reportStudents" tabindex="-1" aria-labelledby="reportStudents" aria-hidden="true">
<form class="form-horizontal"  method="post" enctype="multipart/form-data" action = "../modal_structure/print_function.php">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">
        <div class="modal-header bg-warning ">
            <h5 class="modal-title" id="reportStudents"> Student Reports</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-footer">
            <input type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal"   value="Cancel"/>
            <input type="submit" class="btn btn-primary btn-sm" name="btn_print" id="btn_print" value="Print"/>
        </div>
        </div>
    </div>
</form>
...
<script>
    ...
    $('#_add').on('click', function(){
      ...
      $.ajax({
        url : '../modal_structure/view_students.php',
        data: {
          id: id
        },
        type: 'post',
...
$('#table').on('click', '.edit ', function(){
      ...
      $.ajax({
        url : '../modal_structure/update_students.php',
        data: {
          id: id
        },
        type: 'post',
    ...
    $('#table').on('click', '.del ', function(){
      ...
      $.ajax({
        url : '../modal_structure/delete_students.php',
        data: {
          id: id
        },
        type: 'post',
    ...
    // ********   Script for Report Student   ********
    $('#table').on('click', '.rep', function(){
      var table = $('#table').DataTable();
    
      var id = $(this).data('id');
      $('#reportStudents').modal('show');
      $.ajax({
        url : '../modal_structure/print.php',
        data: {
          id: id
        },
        type: 'post',
        success: function(respose) {
            $('.modal-body-rep').html(respose);
