...
include '../function/totalsubj.php';
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="offcanvas-body p-0">
    <nav class = "navbar-dark">
        <ul class = "navbar-nav">
            ...
            <li>
                <a class="nav-link px-3 sidebar-link active" data-bs-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample">
                    <span class = "me-2">
                        <i class="fa-solid fa-book-open-reader"></i>
                    </span>
                    <span> Subjects</span>
        ...
        <div class = "row">
            ...
            <div class="col-md-3 mb-3">
                <div class="card text-white bg-danger h-100">
                    <div class="card-header">Total Number of Subjects in Grade 1</div>
                    <div class="card-body  text-center">
                        <h5 class="card-title">	<i class="fa-solid fa-book fa-3x rounded-full  p-2" aria-hidden = "true"> </i></a></h5>
                        <p class="card-text text-light"><?= gettotalsubj1(); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card text-white bg-success h-100">
                    <div class="card-header">Total Number of Subjects in Grade 2</div>
                    <div class="card-body  text-center">
                        <h5 class="card-title">	<i class="fa-solid fa-book fa-3x rounded-full  p-2" aria-hidden = "true"> </i></a></h5>
                        <p class="card-text text-light"><?= gettotalsubj2(); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card text-white bg-primary h-100">
                    <div class="card-header">Total Number of Subjects in Grade 3</div>
                    <div class="card-body  text-center">
                        <h5 class="card-title">	<i class="fa-solid fa-book fa-3x rounded-full  p-2" aria-hidden = "true"> </i></a></h5>
                        <p class="card-text text-light"><?= gettotalsubj3(); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- update subjects -->
<div class="modal fade" id="updateSubjects" tabindex="-1" aria-labelledby="updateSubjects" aria-hidden="true">
<form class="form-horizontal"  method="post" enctype="multipart/form-data" action = "../modal_structure/update_subjects.php">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">
        <div class="modal-header bg-success text-white">
            <h5 class="modal-title" id="updateSubjects"> Update  Subjects</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
...
<!-- delete modal -->
<div class="modal fade" id="deleteSubjects" tabindex="-1" aria-labelledby="deleteSubjects" aria-hidden="true">
<form class="form-horizontal"  method="post" enctype="multipart/form-data" action = "../modal_structure/delete_subjects.php">

    <div class="modal-dialog modal-lg">
        <div class="modal-content">
        <div class="modal-header bg-danger text-light">
            <h5 class="modal-title" id="deleteSubjects"> Delete Subjects</h5>
            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
...
<script>
    ...
    $('#_addsub').on('click', function(){
      ...
      var id = $(this).data('id');
      $('#deleteSubjects').modal('show');

      $.ajax({
        url : '../modal_structure/delete_subjects.php',
        data: {
          id: id
        },
        type: 'post',
...
//***************Script for adding category */
    ...
    $('#table').on('click', '.edit ', function(){
      ...
      var id = $(this).data('id');
      $('#updateSubjects').modal('show');

      $.ajax({
        url : '../modal_structure/update_subjects.php',
        data: {
          id: id
        },
        type: 'post',
...
$(document).ready(function() {
    ...
    function fetch_data()
 {
  var dataTable = $('#table').DataTable({
   ...
   "order" : [],
   "ajax" : {
    url:"../function/fetch_data_subject.php",
    type:"POST",
